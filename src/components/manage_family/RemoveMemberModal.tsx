    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-white rounded-3xl shadow-2xl p-6 space-y-3 text-center z-10 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="space-y-2 mt-1">
          <h3 className="text-lg font-bold text-orelio-navy">Remove {selectedMember.firstName}?</h3>
          <p className="text-sm text-orelio-gray leading-relaxed font-medium">
            Removing this profile will permanently delete all the associated data. This action cannot be undone.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-6">
          <button
            onClick={onClose}
            className="flex-1 px-4 py-2.5 text-sm font-bold text-orelio-navy bg-[#E6E8E9] rounded-xl hover:bg-[#D5D7D8] transition-colors"
          >
            Cancel
          </button>
          <button
